						...
						<h1>Lista de articulos</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
								  ...
								  $user_query=mysql_query("select * from articulos where estatus != 'Archivado' and nombre_articulo LIKE  '%$nombre%'
								  OR estatus != 'Archivado' and marca LIKE '%$marca%'")or die(mysql_error());
